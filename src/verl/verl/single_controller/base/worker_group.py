    ...
    def _bind_worker_method(self, user_defined_cls, func_generator):
        ...
        for method_name in dir(user_defined_cls):
            ...
            if hasattr(method, MAGIC_ATTR):
                ...
                # polyrl-dev
                # Example:
                # method_name: actor_rollout_generate_sequences, dispatch_mode: Dispatch.DP_COMPUTE_PROTO, execute_mode: Execute.ALL, blocking: True
                # method_name: actor_rollout_update_actor, dispatch_mode: Dispatch.DP_COMPUTE_PROTO, execute_mode: Execute.ALL, blocking: True
                # method_name: ref_generate_sequences, dispatch_mode: Dispatch.DP_COMPUTE_PROTO, execute_mode: Execute.ALL, blocking: True                               
                # method_name: critic_update_critic, dispatch_mode: Dispatch.DP_COMPUTE_PROTO, execute_mode: Execute.ALL, blocking: True
