...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_stream \
 ...
 actor_rollout_ref.rollout.weight_sender.allowed_sender_ips=$SENDER_IPS \
 actor_rollout_ref.rollout.weight_sender.num_mooncake_engines_per_group=8 \
 actor_rollout_ref.rollout.weight_sender.num_mooncake_groups=4 \
