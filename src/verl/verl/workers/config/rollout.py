...
# polyrl-dev
@dataclass
class WeightSenderConfig(BaseConfig):
    transfer_protocol: str = "tcp"
    transfer_device_name: str = ""
    mooncake_config_path: str = ""
    rpyc_bind_base_port: int = 18861
    mooncake_handshake_port: int = 19000
...
class RolloutConfig(BaseConfig):
    ...
    # polyrl-dev
    # add poly configs
    weight_sender: WeightSenderConfig = field(default_factory=WeightSenderConfig)
