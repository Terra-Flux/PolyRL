...
class FSDPVLLMShardingManager(BaseShardingManager):
    ...
    def preprocess_data(self, data: DataProto) -> DataProto:
        ...
        # polyrl-dev
        # When verl ray trainer rollout, each worker receives different data, completely following the dp way
        # So we need to do all gather within the same TP group
    ...
    def postprocess_data(self, data: DataProto) -> DataProto:
        ...
        # polyrl-dev
        # After TP inference, discard the data that does not belong to the assigned part
