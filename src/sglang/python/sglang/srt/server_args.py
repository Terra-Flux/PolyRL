...
class ServerArgs:
    ...
    # polyrl-dev
    enable_async_server: bool = False
    # NOTE(yongji): Do not add mooncake config path,
    # If you want to set the config file, read it directly through MOONCAKE_CONFIG_PATH
    enable_weight_transfer_agent: bool = False
    mooncake_transfer_protocol: str = "rdma"
    mooncake_transfer_device_name: str = ""
    mooncake_handshake_port: int = 21000
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            "--enable-async-server",
            action='store_true',
            help="Enable async server for PolyRL.",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--mooncake-transfer-protocol",
            type=str,
            default=ServerArgs.mooncake_transfer_protocol,
            help="The transfer protocol used by mooncake (e.g., 'rdma').",
        )
        parser.add_argument(
            "--mooncake-transfer-device-name",
            type=str,
            default=ServerArgs.mooncake_transfer_device_name,
            help="The device name used for mooncake RDMA transfer.",
        )
        parser.add_argument(
            "--mooncake-handshake-port",
            type=int,
            default=ServerArgs.mooncake_handshake_port,
            help="The port used for mooncake P2P handshake.",
        )
        parser.add_argument(
