...
class DataParallelPPOCritic(BasePPOCritic):
    ...
    @GPUMemoryLogger(role="dp critic", logger=logger)
    def compute_values_microbatch(self, data: DataProto) -> torch.Tensor:
        # polyrl-dev
    ...
    def update_critic_microbatch(self, data: DataProto):
        # update critic with a microbatch of data
        # Similar to update_policy_microbatch in dp_actor
