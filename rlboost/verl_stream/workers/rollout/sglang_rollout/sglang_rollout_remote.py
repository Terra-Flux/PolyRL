...
class SGLangRolloutRemote(SGLangRollout):
    ...
    def _init_inference_engine(self, trust_remote_code, actor_module, port):
        ...
        logger.info(f"[SGLangRollout] Waiting for rollout manager to be ready")
        ...
        if first_rank_in_node:
            ...
            args = {
                "rollout_mgr_endpoint": rollout_mgr_endpoint,
            ...
            self._engine = HttpServerAsyncEngineAdapter(**args)
        else:
            self._engine = None
