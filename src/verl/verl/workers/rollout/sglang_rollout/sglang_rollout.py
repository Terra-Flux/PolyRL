...
class SGLangRollout(BaseRollout):
    ...
    def _init_inference_engine(self, trust_remote_code, actor_module, port):
        ...
        if self.config.name == 'sglang-disaggregated':
            raise ValueError("Please init SGLangRolloutRemote instead of SGLangRollout")
    ...
    def _batch_level_generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        if self._tp_rank == 0:
            ...
            if self._engine is not None:
                ...
                # polyrl-dev
                raise ValueError(f"Local inference engine is not initialized, something is wrong")
        else:
            output = None
    ...
    def _req_level_generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        if self._tp_rank == 0:
            # polyrl-dev
            # unroll sample n into independent requests
