...
class Scheduler(
    ...
    def __init__(
        ...
        self._request_dispatcher = TypeBasedDispatcher(
            [
                ...
                (UpdateWeightsFromAgentReqInput, self.update_weights_from_agent),
    ...
    def get_internal_state(self, recv_req: GetInternalStateReq):
        ...
        # polyrl-dev
        # NOTE(liuxs): read #queuing requests to help rollout manager scheduling
        ret["#running_req"] = len(self.running_batch.reqs)
        ret["#queue_req"] = len(self.waiting_queue)
